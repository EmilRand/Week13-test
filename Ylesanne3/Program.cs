...
namespace Ylesanne3
{
    class Program
    {
        ...
        {
            string StarsPath = @"\Users\opilane\samples\Logitpe21\stars.txt";
            string PlanetsPath = @"\Users\opilane\samples\Logitpe21\planets.txt";
            string MilkyWayPath = @"\Users\opilane\samples\Logitpe21\MilkyWay.txt";
